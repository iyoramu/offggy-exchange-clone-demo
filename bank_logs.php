                ...
                <ul class="menu-inner py-1 pt-5 ps">
                    <li class="menu-item py-1">
                        <a href="#" class="menu-link">
                            <div data-i18n="Basic">Logged in </div>
                        </a>
                    </li>
                    <li class="menu-item py-1">
                        <a href="#" class="menu-link">
...
<img src="./assets/images/banklogs/USA.png">
...
<div class="custom-card " style="background-color: #fff;">
<img src="./assets/images/banklogs/aust.png">

<h3 style="color: #000;  ">AUSTRALIA BANK LOGS</h3>
<a href="#">VIEW LOGS</a> 
</div>

<div class="custom-card " style="background-color: #fff;">
<img src="./assets/images/banklogs/CAN.png">

<h3 style="color: #000;  ">CANADA BANK LOGS</h3>
<a href="#">VIEW LOGS</a> 
</div>

<div class="custom-card " style="background-color: #fff;">
<img src="./assets/images/banklogs/UK.png">

<h3 style="color: #000;  ">UK BANK LOGS</h3>
<a href="#">VIEW LOGS</a> 
</div>

<div class="custom-card " style="background-color: #fff;">
<img src="./assets/images/banklogs/ly.png">

<h3 style="color: #000;">PAYPAL LOGS</h3>
<a href="#">VIEW LOGS</a> 
</div>
